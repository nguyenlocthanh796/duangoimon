...
import { playTapSound, playBrewAlarmSound } from '../../../utils/sound';
import { sendBatchBrewLabelToPrinter } from '../../../utils/labelPrinter';
import { useBaristaStore } from '../store';
import { BatchFormula, RecipeBookItem, ActiveBrewTimer } from '../types';
        ...
        {filteredBatches.map(({ formula, parentRecipe }) => {
          ...
          return (
            <View
              key={formula.id}
              style={[
                isWide ? s.brewCardWide : s.brewCardMobile,
                {
