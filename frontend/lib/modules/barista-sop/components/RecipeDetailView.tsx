...
import { sendBatchBrewLabelToPrinter } from '../../../utils/labelPrinter';
import { RecipeBookItem, RecipeSizeVariant, BatchFormula, RecipeIngredientItem } from '../types';
      ...
      >
              ...
              {(recipe.steps || []).map((step, idx) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      isWide ? s.stepCardWide : s.stepCardMobile,
                      {
                        backgroundColor: isDone ? theme.surface.header : theme.surface.card,
                        borderColor: isWide ? (isDone ? theme.brand.success : theme.border.subtle) : theme.border.subtle,
        ...
        {activeTab === 'bom' && (
          <View>
            ...
            <View
              style={[
                isWide ? s.bomTableCardWide : s.bomTableCardMobile,
                {
                  backgroundColor: theme.surface.card,
            ...
            >
              ...
              {scaledIngredients.map((ing: RecipeIngredientItem, idx: number) => {
          ...
          <View>
            {(recipe.batchFormulas || []).map((bf, idx) => (
              <View
                key={bf.id || idx}
                style={[
                  isWide ? s.batchCardWide : s.batchCardMobile,
                  {
                    backgroundColor: theme.surface.card,
                    borderColor: theme.border.subtle,
                    borderWidth: isWide ? 1 : 0,
