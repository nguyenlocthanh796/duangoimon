import { useCallback, useEffect, useMemo, useState } from 'react';
        ...
        const s = StyleSheet.create({
          ...
          addBtnSm: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 12, paddingVertical: 8, borderRadius: shape.radius.md, backgroundColor: colors.brand.primary, marginLeft: 'auto' },
          ...
          typeBtn: { flex: 1, paddingVertical: 8, borderRadius: shape.radius.md, borderWidth: 1.5, borderColor: colors.border.default, alignItems: 'center', backgroundColor: colors.surface.disabled },
