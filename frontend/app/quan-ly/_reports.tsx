  ...
  const renderKpiPanel = () => (
    <View style={styles.panelBox}>
      <View style={styles.panelHeader}>
        ...
        <AppText variant="sm" weight="bold" color={colors.text.primary}>Thống kê tổng quan</AppText>
      </View>
      <View style={{ alignItems: 'center', paddingVertical: 4 }}>
        <AppText variant="lg" weight="bold" color={colors.brand.primary}>{formatVND(totalRevenue)}</AppText>
        <AppText variant="sm" color={colors.text.muted}>Tổng doanh thu kỳ này</AppText>
      </View>
      ...
      <View style={{ flexDirection: 'row', gap: 8 }}>
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          ...
          <AppText variant="sm" color={colors.text.muted}>Trung bình/ngày</AppText>
        </View>
      </View>
    </View>
  );
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.surface.app }}>
      ...
      {isWide ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{ paddingHorizontal: 8 }} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={colors.brand.primary} />}>
          {/* Bar Chart */}
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Icon name="chart-bar" size={18} color={colors.brand.primary} />
