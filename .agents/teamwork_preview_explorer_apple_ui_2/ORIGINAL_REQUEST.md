...
Identify which files need changes, locate the lines, and propose the exact edits. Write your report to e:\posa\.agents\teamwork_preview_explorer_apple_ui_2\analysis.md and notify me (the orchestrator) when done.
