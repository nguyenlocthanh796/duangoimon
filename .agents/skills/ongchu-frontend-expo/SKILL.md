...
## 📱 QUY CHUẨN TOÀN MÀN HÌNH NỘI TUYẾN (ZERO-MODAL DETAIL INVARIANT)
...
- [component-hierarchy.md](file:///d:/duanpos-ongchu/.agents/skills/ongchu-frontend-expo/references/component-hierarchy.md): Cây phân cấp component và luồng dữ liệu props.
- [state-management.md](file:///d:/duanpos-ongchu/.agents/skills/ongchu-frontend-expo/references/state-management.md): Chi tiết cấu trúc Zustand Store và các action nghiệp vụ.
- [ui-invariants.md](file:///d:/duanpos-ongchu/.agents/skills/ongchu-frontend-expo/references/ui-invariants.md): Danh sách các quy tắc giao diện bắt buộc không được vi phạm.

---

## 🛠️ CÁCH BIÊN DỊCH & KIỂM THỬ FRONTEND
...
# Mở trên Web PWA
# Truy cập: http://localhost:8085 (hoặc 8082)

# Chạy trên Android Emulator / Thiết bị thật
